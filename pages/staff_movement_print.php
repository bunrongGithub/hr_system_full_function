...
if (isset($_GET['id'])) {
   $id = $_GET['id'];
   $sql = "SELECT * FROM staff_movement LEFT JOIN company on company.c_id = staff_movement.sm_new_info_company 
   LEFT JOIN user_branch ON user_branch.ub_id = staff_movement.sm_new_info_branch
   LEFT JOIN department ON department.de_id = staff_movement.sm_new_info_department 
   LEFT JOIN position ON position.position_id = staff_movement.sm_new_info_position WHERE sm_id = $id";
                        ...
                        <div class="box-body table-responsive">
                           <div class="col-md-12">
                              <form action="" method="post" enctype="multipart/form-data">
                                 <input type="hidden" name="" value="<?php echo $row['sm_id'] ?>" id="">
                                 ...
                                 <div class=" form-group col-md-12">
                                    ...
                                    <div class="form-group col-md-4">
                                       <label class="form-label" for="sm_no">SM No:</label>
                                       <input type="text" class="form-control" name="sm_no" id="sm_no" value="<?php echo $row['sm_no'] ?>">
                                    </div>
                                    <div class="form-group col-md-4">
                                       <label class="form-label" for="date">Date:</label>
                                       <input type="date" class="form-control" name="date" id="date" value="<?php echo $row['sm_applied_date'] ?>">
                                    </div>
                                    <div class="form-group col-md-4">
                                    ...
                                    <div class="col-md-6">
                                       <div class="col-md-12">
                                          ...
                                          <div class="col-md-12">
                                             ...
                                             <input class="form-control" type="text" name="company" id="company" value="<?php echo $row['c_name_kh']; ?>">
                                          </div>
                                          <div class="col-md-12">
                                             <label for="branch">Branch:</label>
                                             <input class="form-control" type="text" name="branch" id="branch" value="<?php echo $row['ub_name']; ?>">
                                          </div>
                                          <div class="col-md-12">
                                             <label for="department">Deparment:</label>
                                             <input class="form-control" type="text" name="department" id="department" value="<?php echo $row['de_name']; ?>">
                                          </div>
                                          <div class="col-md-12">
                                             <label for="position">Position:</label>
                                             <input class="form-control" type="text" name="position" id="position" value="<?php echo $row['position']; ?>">
                                          </div>
                                          <div class="col-md-12">
                                             ...
                                             <div class="input-group">
                                                ...
                                                <input class="form-control" type="text" name="salary" id="salary" value="<?php echo $row['sm_salary'] . '$' ?>">
                                             </div>
                                          </div>
                                          <div class="col-md-12">
                                             ...
                                             <div class="input-group">
                                                ...
                                                <input class="form-control" type="text" name="tax_salary" id="tax_salary" value="<?php echo $row['sm_tax_salary'] . '$' ?>">
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                 ...
                                 <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" name="reason" id="reason" rows="2"><?php echo $row['sm_reason'] ?></textarea>
                                 </div>
                                 <div class="col-md-12">
                                    <label for="noted">Noted:</label>
                                    <textarea class="form-control" name="noted" id="noted" rows="2"><?php echo $row['sm_note'] ?></textarea>
                                 </div>
                                 <div class="col-md-12">
                                    <div class="col-xs-3">
                                 ...
                                 <div style="margin-top: 10px;" class="col-md-12">
                                    ...
                                    <a id="medaiprint" style="color: white;" class="btn btn-lg btn-danger" href="staff_movement.php"><i class="fa fa-undo"></i></a>
                                 </div>
                              </form>
                           </div>
                        </div>

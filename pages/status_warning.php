...
if (isset($_POST["btnupdate"])) {
    ...
    $sql = "UPDATE text_warning_status SET
                    tws_name = '$edit_name'
                    WHERE tws_id = $id";
    $result = mysqli_query($connect, $sql);
    header('location: status_warning.php?message=update');
}
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <h1 class="text-primary">Status Staff Warning<h1>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center" style="vertical-align: middle;" >
                                                <!--list-->
                                                <a href="status_warning_user.php?sent_id=<?php echo $row['tws_id']; ?>" class="btn btn-info btn-sm">

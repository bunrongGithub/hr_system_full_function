...
if (isset($_POST["btnadd"])) {
    ...
    $v_er_id = $_POST["adasss_er_id"];
    $v_emp_name = $_POST["adasss_emp_name"];
    $v_position = $_POST["adasss_position"];
    $v_useday = $_POST["adasss_using_date"];
    $v_wddate = $_POST["adasss_withdrawn_date"];
    $v_status = $_POST["adasss_status"];

    $sql = "INSERT INTO admin_asset_usage  
                        ( 
                        adasss_category,
                        adasss_code,
                        adasss_type,
                  ...
                  VALUES 
                    ...
                    '$v_qty','$v_mou','$v_amount','$v_er_id',
                    '$v_emp_name','$v_position','$v_useday','$v_wddate',
                    '$v_status','$user_id','$yeardate')";
...
if (isset($_POST["btnupdate"])) {
    ...
    $sql = "UPDATE admin_asset_usage SET 
                        adasss_category ='$v_category',
                        adasss_code ='$v_code',
                        adasss_type ='$v_type',
                        adasss_asset_name ='$v_name',
                        adasss_qty ='$v_qty',
                        adasss_mou ='$v_mou',
                        adasss_amount ='$v_amount',
                        adasss_er_id ='$v_er_id',
                        adasss_emp_name ='$v_emp_name',
                        adasss_position ='$v_position',
                        adasss_using_date ='$v_useday',
                        adasss_withdrawn_date ='$v_wddate',
                        adasss_status ='$v_status' WHERE adasss_id = $id";

    $result = mysqli_query($connect, $sql);
    header('location:admin_asset_usage.php?message=update');
}
                                            ...
                                            <div class="modal-body">
                                                <div class="col-md-12">
                                                    <form method="post" enctype="multipart/form-data" action="">
                                                        ...
                                                        <div class="row col-xs-4">
                                                            <div class="form-group col-xs-12">
                                                                <label>PA Nº Ref:</label>
                                                                <select class="form-control" id="txt_pa_ref" name="txt_pa_ref" data-live-search="true">
                                                        ...
                                                        <div class="row col-xs-4">
                                                            ...
                                                            <div class="show_hid form-group col-xs-12" style="visibility: hidden;">
                                                                ...
                                                                <input class="form-control" id="txt_drawn_date" name="txt_drawn_date" type="date">
                                                            </div>
                                                            <div class="show_hid form-group col-xs-12" style="visibility: hidden;">
                                                                <label>Status:</label>
                                                ...
                                                <div class="col-md-12">
                                                    <form method="post" enctype="multipart/form-data" action="">
                                                        ...
                                                        <div class="row col-xs-4">
                                                            <div class="form-group col-xs-12">
                                                                <label>PA Nº Ref:</label>
                                                                <select class="form-control" id="edit_pa_ref" name="edit_pa_ref" data-live-search="true">
                                                                    <option disabled selected>Please Select Job ID</option>
                                                                    <?php
                                                                    $sql = 'SELECT * FROM employee_registration';
                                                                    $result = mysqli_query($connect, $sql);
                                    ...
                                    <table id="info_data" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                $v_uprice = "";
                                                $v_emp_name = $row["adasss_emp_name"];
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a onclick="doUpdate(
                                                        '<?php echo $row['adasss_id']; ?>',
                                                        '<?php echo $row['adasss_category']; ?>',
                                                        '<?php echo $row['adasss_code']; ?>',
                                                        '<?php echo $row['adasss_type']; ?>',
                                                        '<?php echo $row['adasss_asset_name']; ?>',
                                                        '<?php echo $row['adasss_qty']; ?>',
                                                        '<?php echo $row['adasss_mou']; ?>',
                                                        '<?php echo $row['adasss_amount']; ?>',
                                                        '<?php echo $row['adasss_er_id']; ?>',
                                                        '<?php echo $row['adasss_emp_name']; ?>',
                                                        '<?php echo $row['adasss_position']; ?>',
                                                        '<?php echo $row['adasss_using_date']; ?>',
                                                        '<?php echo $row['adasss_withdrawn_date']; ?>',
                                                        '<?php echo $row['adasss_status']; ?>',

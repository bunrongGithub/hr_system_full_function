...
if (isset($_POST["btnadd"])) {
    ...
    $sql = "INSERT INTO user_auth_department
                        ( uad_dep_id 
                        , uad_user_id
                        ) 
                  VALUES 
    ...
    header("location:user_department_sub.php?id=$v_get_id");
}
...
if (isset($_GET["del_id"])) {
    ...
    $sql = "DELETE FROM user_auth_department WHERE uad_id = '$del_id'";
    $result = mysqli_query($connect, $sql);
    header("location:user_department_sub.php?id=$v_get_id");
}
                                ...
                                <div class="box-body table-responsive">
                                    <table id="info_data" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $set_id = $_GET["id"];
                                            $sql = "SELECT * FROM user_auth_department A
                                                        LEFT JOIN user B ON B.id=A.uad_user_id
                                                        LEFT JOIN department C ON C.de_id=A.uad_dep_id
                                                        WHERE uad_user_id=$set_id
                                                        ";
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?php echo $v_i; ?></td>
                                                    <td>
                                                        <?php echo $v_name; ?> - <?php echo $v_note; ?>
                                                    </td>
                                                    <td style="text-align:center;">
                                                        ...
                                                        '<?php echo $v_name; ?>')" data-toggle="modal" data-target="#myModal_update" class="btn btn-primary btn-sm"><i style="color:white;" class="fa fa-edit"></i></a>
                                                         -->
                                                        <a onclick="return confirm('Are you sure to delete ?');" href="user_department_sub.php?del_id=<?php echo $row['uad_id']; ?>&sent_user_id=<?php echo $row['uad_user_id']; ?>" class="btn btn-danger btn-sm"><i style="color:white;" class="fa fa-trash "></i></a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }

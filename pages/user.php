...
if (isset($_POST["btnadd"])) {
   ...
   $v_start_time = $_POST["txt_start_time"];
   $v_end_time = $_POST["txt_end_time"];
...
if (isset($_POST["btnupdate"])) {
   ...
   $sql = "UPDATE user SET username = '$v_name' , 
                            position_id = '$v_position' , 
                            u_department_id = '$v_department' , 
                            u_branch_id = '$v_branch' , 
                                       ...
                                       <form method="post" enctype="multipart/form-data" action="">
                                          ...
                                          <div class="col-md-6">
                                             ...
                                             <div class="col-xs-12">
                                                ...
                                                <div class="input-wrapper">
                                                   <input class="form-control" id="txt_con_pwd" name="txt_con_pwd" type="password" autocomplete="off" onkeyup="matchPassword();">
                                             ...
                                             <div class="col-xs-12">
                                                ...
                                                <input class="form-control" name="txt_start_time" type="date" required="required">
                                             </div>
                                             <div class="col-xs-12">
                                                <label>End Time:</label>
                                                <input class="form-control" name="txt_end_time" type="date" required="required">
                                             </div>
                                          </div>
                                          <div class="col-md-6">
                           ...
                           <table id="info_data" class="table table-bordered table-striped">
                              ...
                              <tbody>
                                 ...
                                 $sql = "SELECT * FROM user
                                                    LEFT JOIN employee_registration on employee_registration.er_id=user.u_job_id
                                    ...
                                    <tr>
                                       ...
                                       <td>******
                                          <a style="float:right; cursor:pointer;" onclick="doPWD(<?php echo $row['id']; ?>,
                                                            ...
                                                            )" data-toggle="modal" data-target="#myModal_pwd"><i style="color:#3c8dbc;" class="fa fa-pencil "></i></a>
                                       </td>
                                       ...
                                       <td>
                                          <div>
                                             Group:
                                             <a href="user_com_group_sub.php?id=<?php echo $row['id']; ?>"><i style="color:blue;" class="fa fa-key"></i></a>
                                             <span style="color:red">
                                                <?php
                                                $v_user_id = $row["id"];
                                                $sql_group = "SELECT COUNT(*) AS countid FROM user_auth_company_group
                                                               WHERE uacg_user_id=$v_user_id
                                                               ";
                                                $result_group = $connect->query($sql_group);
                                                $row_group = $result_group->fetch_assoc();
                                                $get_count_group = $row_group['countid'];
                                                echo $get_count_group;
                                                ?>
                                             </span>

                                             <br>Company:
                                             <a href="user_company_sub.php?id=<?php echo $row['id']; ?>"><i style="color:blue;" class="fa fa-key"></i></a>
                                             <span style="color:red">
                                                <?php
                                                $v_user_id = $row["id"];
                                                $sql_com = "SELECT COUNT(*) AS countid FROM user_auth_company
                                                               WHERE uac_user_id=$v_user_id
                                                               ";
                                                $result_com = $connect->query($sql_com);
                                                $row_com = $result_com->fetch_assoc();
                                                $get_count_com = $row_com['countid'];
                                                echo $get_count_com;
                                                ?>
                                             </span>

                                             <br>Branch:
                                             <a href="user_branch_sub.php?id=<?php echo $row['id']; ?>"><i style="color:blue;" class="fa fa-key"></i></a>
                                             <span style="color:red">
                                                <?php
                                                $v_user_id = $row["id"];
                                                $sql_branch = "SELECT COUNT(*) AS countid FROM user_auth_branch
                                                               WHERE uab_user_id=$v_user_id
                                                               ";
                                                $result_branch = $connect->query($sql_branch);
                                                $row_branch = $result_branch->fetch_assoc();
                                                $get_count_branch = $row_branch['countid'];
                                                echo $get_count_branch;
                                                ?>
                                             </span>

                                             <br> Department:
                                             <a href="user_department_sub.php?id=<?php echo $row['id']; ?>"><i style="color:blue;" class="fa fa-key"></i></a>
                                             <span style="color:red">
                                                <?php
                                                $v_user_id = $row["id"];
                                                $sql_branch = "SELECT COUNT(*) AS countid FROM user_auth_department
                                                               WHERE uad_user_id=$v_user_id
                                                               ";
                                                $result_dep = $connect->query($sql_branch);
                                                $row_dap = $result_dep->fetch_assoc();
                                                $get_count_dep = $row_dap['countid'];
                                                echo $get_count_dep;
                                                ?>
                                             </span>

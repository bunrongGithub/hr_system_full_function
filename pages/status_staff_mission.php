...
if (isset($_POST["btnupdate"])) {
    ...
    $sql = "UPDATE text_mission_status SET
                    tms_name = '$edit_name'
                    WHERE tms_id = $id";
    $result = mysqli_query($connect, $sql);
    header('location:status_staff_mission.php?message=update');
}
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <h1 class="text-primary">Status Staff Mission<h1>
                    ...
                    <div class="col-xs-12 connectedSortable">
                        <div style="margin-top: -2%;" class="box">
                            <table id="info_data" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                    $sql = "SELECT * FROM text_mission_status A
                                            ";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center" style="vertical-align: middle;" >
                                                <!--list-->
                                                <a href="status_staff_mission_user.php?sent_id=<?php echo $row['tms_id']; ?>" class="btn btn-info btn-sm">

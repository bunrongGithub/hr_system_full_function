...
if (isset($_GET['id'])) {
   ...
   header('location:e_form.php?message=delete');
}
...
if (isset($_POST["btnadd"])) {
   ...
   $result = mysqli_query($connect, $sql);
   header('location:e_form.php?message=success');
}
...
if (isset($_POST['update'])) {
   ...
   header('location:e_form.php?message=update');
   exit();
}
      ...
      if($imageFileType ==="pdf"){
         if ($v_image['name'] != "") {
            ...
            if ($connect->query($query_update)) {
               header("location:e_form.php?message=update_file");
            } else {
               header('location:e_form.php?message=update_file_error');
            }
         }
                              ...
                              ?>
                                 <tr>
                                    ...
                                    <td>
                                       ...
                                       <a onclick="return confirm('Are you sure to delete?');" href="e_form.php?id=<?php echo $row['ef_id']; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                    </td>
                                 </tr>
                                 <!-- modal_update_file -->

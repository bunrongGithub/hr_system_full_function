   ...
   <div class="wrapper row-offcanvas row-offcanvas-left">
      ...
      <aside class="right-side">
         <section class="content-header">
            <h1 class="text-primary">Personal Task</h1>
               ...
               <div class="col-xs-12 connectedSortable">
                  <div class="box">
                     <div class="box-body table-responsive">
                        <table id="table_personal_task" class="table table-bordered table-striped">
                           <thead>
                              <tr>
                                 <th>No.</th>
                                 <th>Task_No</th>
                                 ...
                                 <th>Company</th>
                                 <th>Note</th>
                                 <th style="width:110px;"><i class="fa fa-cog" aria-hidden="true"></i></th>
                              </tr>
                           </thead>
                           <tbody>
                              <?php
  ...
  <script src="http://ajax.googleapis.com/ajax/libs/jquery/2.0.2/jquery.min.js"></script>
   ...
   <script type="text/javascript">
      ...
      $(function() {
         ...
         $("#person_task").addClass("active");
         $("#person_task").css("background-color", "##367fa9");
         $('#table_personal_task').dataTable();
      });
   </script>
</body>

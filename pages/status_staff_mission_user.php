...
if (isset($_GET['del_id'])) {
    ...
    $id = $_GET['del_id'];
    $sql = "DELETE FROM text_mission_status_user where msu_id = '$id'";
    $result = mysqli_query($connect, $sql);
    header("location: status_staff_mission_user.php?sent_id=$v_status_id");
}
...
if (isset($_POST["btnadd"])) {  
    ...
    $sql = "INSERT INTO text_mission_status_user
                        (msu_user_id
                        , msu_status_id
                        , created_at)
                    VALUES
...
if (isset($_POST["btnupdate"])) {
    ...
    $sql = "UPDATE text_mission_status_user SET
                        msu_user_id = '$edit_name'
                        WHERE msu_id = $id";
    $result = mysqli_query($connect, $sql);
    header("location: status_staff_mission_user.php?sent_id=$v_status_id");
    exit();
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <h1 class="text-primary">Status Request New Position (User Auth)<h1>
                    ...
                    <a href="status_staff_mission.php" class="btn btn-danger btn-sm">
                        ...
                        <div style="margin-top: -2%;" class="box">
                            ...
                            <table id="info_data" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                    $id = $_GET['sent_id'];
                                    $sql = "SELECT * FROM text_mission_status_user A
                                            LEFT JOIN  text_mission_status B ON B.tms_id=A.msu_status_id
                                            LEFT JOIN user C ON C.id=A.msu_user_id
                                            WHERE msu_status_id=$id
                                            ";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center" style="vertical-align: middle;" >
                                                ...
                                                <a onclick="doUpdate(
                                                                    '<?php echo $row['msu_id']; ?>',
                                                                    '<?php echo $row['msu_user_id']; ?>'
                                                                    )" data-toggle="modal" data-target="#modalupdate" class="btn btn-primary btn-sm">
                                                    <i style="color: white;" class="fa fa-edit"></i>
                                                </a>
                                                <!-- delete -->
                                                <a onclick="return confirm('Are you sure to delete ?');" href="status_staff_mission_user.php?del_id=<?php echo $row['msu_id']; ?>&sent_id=<?php echo $row['msu_status_id']; ?>" class="btn btn-danger btn-sm">
   ...
   <script src="../js/AdminLTE/app.js" type="text/javascript"></script>
        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                $("#status_mission").addClass("active");
                $("#status_mission").css("background-color", "##367fa9");
                $('#info_data').dataTable();
            });
        </script>

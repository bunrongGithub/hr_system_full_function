...
if (isset($_GET['id'])) {
   $id = $_GET['id'];
   $sql = "SELECT * FROM jobhangout A left join employee_registration B on B.er_id = A.jh_job_id
   left join company C on C.c_id = B.er_company_id WHERE jh_id = $id";
                           ...
                           <div class="container">
                              <div class="col-md-12">
                                 <form action="" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="" value="<?php echo $row['jh_id'] ?>" id="">
                                    ...
                                    <div class="header_input">
                                       ...
                                       <div class="input_div">
                                          <label for="rnp_no">JHR No:</label>
                                          <input type="text" class="input_header" name="rnp_no" id="rnp_no" value="<?php echo $row['jh_no'] ?>">
                                       </div>
                                       <div class="input_div">
                                          <label for="date">Applied Date:</label>
                                          <input type="date" class="input_header" name="date" id="date" value="<?php echo $row['jh_applied_date'] ?>">
                                       </div>
                                    </div>
                                    <div class="header_input">
                                       <div class="input_div">
                                    ...
                                    <div class="header_input">
                                       <div class="input_div">
                                          ...
                                          <input class="input_header" type="number" name="" value="<?php echo $row['jh_period'] ?>" id="">
                                       </div>
                                       <div class="input_div">
                                          <label for="">From:</label>
                                          <input class="input_header" type="date" name="" value="<?php echo $row['jh_from'] ?>" id="">
                                       </div>
                                       <div class="input_div">
                                          <label for="">To:</label>
                                          <input class="input_header" type="date" name="" value="<?php echo $row['jh_to'] ?>" id="">
                                       </div>
                                       <div class="input_div">
                                          <label for="">Re-Work Date:</label>
                                          <input class="input_header" type="date" name="" value="<?php echo $row['jh_restart_date'] ?>" id="">
                                       </div>
                                       <div class="input_div">
                                          <label for="">Status:</label>
                                          <input class="input_header" value="<?php $tts_id = $row['jh_status_id'];
                                                                              $sql = "SELECT * FROM text_termination_status where tts_id = '$tts_id'";
                                                                              $result = $connect->query($sql);
                                                                              $result_row = $result->fetch_assoc();
                                                                              $result_show = $result_row['tts_name'];
                                                                              echo $result_show; ?>" type="text" name="" id="">
                                       </div>

                                    </div>
                                    <div class="infor_reason">
                                       <label class="form-label" for="">Reason:</label>
                                       <textarea name="" id="" rows="2"><?php echo $row['jh_reason'] ?></textarea>
                                    </div>
                                    ...
                                    <div style="margin-top: 10px;">
                                          ...
                                          <a id="medaiprint" style="color: white;" class="btn btn-lg btn-danger" href="./staff_job_hangout.php"><i class="fa fa-undo"></i></a>
                                       </div>
                                 </form>
                              </div>
                           </div>

...
if (isset($_POST["btnadd"])) {
    ...
    $sql = "INSERT INTO set_commission 
                        ( com_name ) 
                  VALUES 
                    ('$v_name')";
    $result = mysqli_query($connect, $sql);
    header('location:set_commission.php?message=success');
}
...
if (isset($_POST["btnupdate"])) {
    ...
    $sql = "UPDATE commission SET com_name = '$v_name' WHERE com_id = $id";

    $result = mysqli_query($connect, $sql);
    header('location:set_commission.php?message=update');
}

if (isset($_GET["del_id"])) {
    $id = $_GET["del_id"];

    $sql = "DELETE FROM commission WHERE com_id = '$id'";
    $result = mysqli_query($connect, $sql);
    header("location: set_commission.php?message=delete");
}
...
<body class="skin-black">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align:center;">
                                                        <!-- <a href="edit_set_commission.php?id=<?php echo $row['com_id']; ?>" class="btn btn-info btn-sm"><i style="color:white;" class="fa fa-eye"></i></a> -->
                                                        <a onclick="doUpdate(<?php echo $row['com_id']; ?>,
                                                        ...
                                                        <a onclick="return confirm('Are you sure to delete ?');" href="set_commission.php?del_id=<?php echo $row['com_id']; ?>" class="btn btn-danger btn-sm"><i style="color:white;" class="fa fa-trash "></i></a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            $("#set_commission").addClass("active");
            $("#set_commission").css("background-color", "##367fa9");

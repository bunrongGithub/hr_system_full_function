...
if (isset($_POST["btnupdate"])) {
    ...
    $sql = "UPDATE text_requ_new_pos_status SET
                    trnp_name = '$edit_name'
                    WHERE trnp_id = $id";
    $result = mysqli_query($connect, $sql);
    header('location: status_request_new_position.php?message=update');
}
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <h1 class="text-primary">Staff Status Request New Position<h1>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center" style="vertical-align: middle;" >
                                                <!--list-->
                                                <a href="status_request_new_position_user.php?sent_id=<?php echo $v_id; ?>" class="btn btn-info btn-sm">

...
if (isset($_GET['id'])) {
   $id = $_GET['id'];
   $sql = "SELECT * FROM termination A left join employee_registration B on B.er_id = A.te_employee_id
   left join company C on C.c_id = B.er_company_id WHERE te_id = $id";
                           ...
                           <div class="container">
                              <div class="col-md-12">
                                 <form action="" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="" value="<?php echo $row['te_id'] ?>" id="">
                                    ...
                                    <div class="header_input">
                                       ...
                                       <div class="input_div">
                                          <label for="rnp_no">Terminate No:</label>
                                          <input type="text" class="input_header" name="rnp_no" id="rnp_no" value="<?php echo $row['te_terninate_no'] ?>">
                                       </div>
                                       <div class="input_div">
                                          <label for="date">Date:</label>
                                          <input type="date" class="input_header" name="date" id="date" value="<?php echo $row['te_terminate_date'] ?>">
                                       </div>
                                    </div>
                                    <div class="header_input">
                                       <div class="input_div">
                                    ...
                                    <div class="current_info">
                                       ...
                                       <div class="input_div_info">
                                          ...
                                          <input class="input_header" type="text" name="" value="<?php echo $row['te_total_warning'] ?>" id="">
                                       </div>
                                       <div class="input_div_info">
                                          <label for="">Paid / Unpaid:</label>
                                          <input class="input_header" type="text" name="" value="
                                          <?php
                                          $paid = $row['te_paid_unpaid'];
                                          switch ($paid) {
                                             case 1:
                                                echo "Paid";
                                                break;
                                       ...
                                       <div class="input_div_info">
                                          <label for="">Staff Liability:</label>
                                          <input class="input_header" type="text" name="" value="<?php $ability = $row['te_staff_liability'];
                                                                                                   switch ($ability) {
                                                                                                      case 1:
                                                                                                         echo "No";
                                                                                                         break;
                                       ...
                                       <div class="input_div_info">
                                          <label for="">Liability Amount:</label>
                                          <input class="input_header" type="text" name="" value="<?php echo $row['te_liability_amount'] . '$' ?>" id="">
                                       </div>
                                    </div>
                                    <div class="infor_reason">
                                       <label class="form-label" for="">Reason:</label>
                                       <textarea name="" id="" rows="2"><?php echo $row['te_reason'] ?></textarea>
                                    </div>
                                    <div style="margin-bottom: 25px;" class="col-md-12">
                                       ...
                                       <div style="margin-top: 10px;">
                                          ...
                                          <a id="medaiprint" style="color: white;" class="btn btn-lg btn-danger" href="./staff_termination.php"><i class="fa fa-undo"></i></a>
                                       </div>
                                    </div>
                                 </form>
                              </div>

...
if (isset($_GET['data'])) {
   $v_data_id = $_GET['data']; //1
   $sql = "SELECT * FROM salary_confirmation_letter LEFT JOIN employee_registration ON employee_registration.er_id = salary_confirmation_letter.scl_er_id
                  LEFT JOIN company ON company.c_id = employee_registration.er_company_id 
      WHERE scl_id = '$v_data_id' limit 1";
...
<body onload="window.print()">
   ...
   <div class="paragraph2">
      <div class="par2-1">
         <pre>
1-     Name:.............................................      Gender:.................    Birthday: ..............................   ID
        N<sup>o</sup>: .....................................    Position: ..............................    was   complete  his/her    job   in
...
2-     The Employee Information as detail below :
     -  Start Working Date: ..............................................  Start Position: .............................................
     -  Complete Date: .....................................................  Last Position: ...............................................
     -  Job Contract Status:    <input type="checkbox">  Complete    <input type="checkbox">  Position    <input type="checkbox">  Resigned

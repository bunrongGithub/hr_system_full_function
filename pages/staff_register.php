...
if (isset($_GET['del_id'])) {
   $id = $_GET['del_id'];
   $sql = "DELETE FROM benefit_info where bi_id = '$id'";
   $result = mysqli_query($connect, $sql);
   header(('location:staff_register.php?message=delete'));
}
...
if (isset($_POST["btnadd"])) {
   ...
   header("location:staff_register_view.php?id=$v_id");
   exit();
}
   ...
   <script type="text/javascript">
      function doImage(id, cardf) {
         ...
         if (cardf == '') {
            ...
            document.getElementById('show_photo').setAttribute('src', '../img/upload/staff_register_img/' + cardf);
         }
      }

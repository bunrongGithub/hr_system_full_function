...
if (isset($_POST["btnadd"])) {
    ...
    $sql = "INSERT INTO pension 
                        ( pe_range_from , pe_range_to , pe_amount_usd , pe_amount_khr ) 
                  VALUES 
                    ('$v_range_from', '$v_range_to', '$v_amount_usd', '$v_amount_khr')";
    $result = mysqli_query($connect, $sql);
    header('location:pension.php?message=success');
}
...
if (isset($_POST["btnupdate"])) {
    ...
    $sql = "UPDATE pension SET pe_range_from = '$v_range_from', 
                                pe_range_to = '$v_range_to', 
                                pe_amount_usd = '$v_amount_usd', 
                                pe_amount_khr = '$v_amount_khr' WHERE pe_id = $id";

    $result = mysqli_query($connect, $sql);
    header('location:pension.php?message=update');
}

if (isset($_GET["del_id"])) {
    $id = $_GET["del_id"];

    $sql = "DELETE FROM pension WHERE pe_id = '$id'";
    $result = mysqli_query($connect, $sql);
    header("location: pension.php?message=delete");
}
...
<body class="skin-black">
                                                    ...
                                                    <form method="post" enctype="multipart/form-data" action="">
                                                        ...
                                                        <div class="form-group col-xs-6">
                                                            ...
                                                            <div class="input-group ">
                                                                ...
                                                                <input class="form-control" id="txt_amount_usd" name="txt_amount_usd" type="number" step="0.01">
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-xs-6">
                                                            ...
                                                            <div class="input-group ">
                                                                <div class="input-group-addon">៛</div>
                                                                <input class="form-control" id="txt_amount_khr" name="txt_amount_khr" type="number" step="100">
                                                            </div>
                                                        </div>
                                                </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="col-md-12">
                                                    <form method="post" enctype="multipart/form-data" action="">
                                                        <input type="hidden" id="pension_id" name="pension_id" />
                                                        <div class="form-group col-xs-6">
                                                            <label>Range From:</label>
                                                        ...
                                                        <div class="form-group col-xs-6">
                                                            ...
                                                            <div class="input-group ">
                                                                <div class="input-group-addon">$</div>
                                                                <input class="form-control" id="edit_amount_usd" name="edit_amount_usd" type="number" step="0.01">
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-xs-6">
                                                            <label>Amount KHR:</label>
                                                            <div class="input-group ">
                                                                <div class="input-group-addon">៛</div>
                                                                <input class="form-control" id="edit_amount_khr" name="edit_amount_khr" type="number" step="100">
                                                            </div>
                                                        </div>
                                                </div>
                                                <div class="modal-footer">
                                    ...
                                    <table id="info_data" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                $v_i = $i++;
                                                $v_range_from = $row["pe_range_from"];
                                                $v_range_to = $row["pe_range_to"];
                                                $v_amount_usd = $row["pe_amount_usd"];
                                                $v_amount_khr = $row["pe_amount_khr"];
                                            ?>
                                                <tr>
                                                    <td><?php echo $v_i; ?></td>
                                                    <td><?php echo $v_range_from; ?></td>
                                                    <td><?php echo $v_range_to; ?></td>
                                                    <td><?php echo $v_amount_usd; ?></td>
                                                    <td><?php echo $v_amount_khr; ?></td>
                                                    <td style="text-align:center;">
                                                        <!-- <a href="edit_pension.php?id=<?php echo $row['pe_id']; ?>" class="btn btn-info btn-sm"><i style="color:white;" class="fa fa-eye"></i></a> -->
                                                        <a onclick="doUpdate(<?php echo $row['pe_id']; ?>,
                                                        '<?php echo $v_range_from; ?>',
                                                        '<?php echo $v_range_to; ?>',
                                                        '<?php echo $v_amount_usd; ?>',
                                                        '<?php echo $v_amount_khr; ?>')" data-toggle="modal" data-target="#myModal_update" class="btn btn-primary btn-sm"><i style="color:white;" class="fa fa-edit"></i></a>
                                                        <a onclick="return confirm('Are you sure to delete ?');" href="pension.php?del_id=<?php echo $row['pe_id']; ?>" class="btn btn-danger btn-sm"><i style="color:white;" class="fa fa-trash "></i></a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
    ...
    <script type="text/javascript">
        function doUpdate(id, range_from, range_to, amount_usd, amount_khr) {
            $('#pension_id').val(id);

...
if (isset($_POST["btnupdate"])) {
   ...
   $sql = "UPDATE text_staff_moment_status SET
                    sms_name = '$edit_name'
                    WHERE sms_id = $id";
   $result = mysqli_query($connect, $sql);
   header('location:status_staff_movement.php?message=update');
}
                           ...
                           ?>
                              <tr>
                                 ...
                                 <td class="text-center" style="vertical-align: middle;">
                                    <!--list-->
                                    <a href="status_staff_movement_user.php?sent_id=<?php echo $row['sms_id']; ?>" class="btn btn-info btn-sm">

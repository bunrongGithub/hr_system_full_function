...
if (isset($_GET['id'])) {
   $id = $_GET['id'];
   $sql = "SELECT * FROM mission A left join employee_registration B on B.er_id = A.mi_job_id
      left join company C on C.c_id = B.er_company_id   WHERE mi_id = $id";
                           ...
                           <div class="container">
                              <div class="col-md-12">
                                 <form action="" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="" value="<?php echo $row['mi_id'] ?>" id="">
                                    ...
                                    <div class="header_input">
                                       ...
                                       <div class="input_div">
                                          <label for="rnp_no">Mission Nº:</label>
                                          <input type="text" class="input_header" name="rnp_no" id="rnp_no" value="<?php echo $row['mi_misson_no'] ?>">
                                       </div>
                                       <div class="input_div">
                                          <label for="date">Applied Date:</label>
                                          <input type="date" class="input_header" name="date" id="date" value="<?php echo $row['mi_date_applied'] ?>">
                                       </div>
                                    </div>
                                    <div class="header_input">
                                       <div class="input_div">
                                    ...
                                    <div class="header_input">
                                       <div class="input_div">
                                          <label for="">Total Period:</label>
                                          <input type="number" class="input_header" value="<?php echo $row['mi_period']; ?>" name="" id="">
                                       </div>
                                       <div class="input_div">
                                          <label for="">Date From:</label>
                                          <input type="date" class="input_header" value="<?php echo $row['mi_date_from']; ?>" name="" id="">
                                       </div>
                                       <div class="input_div">
                                          <label for="">Date To:</label>
                                          <input type="date" class="input_header" value="<?php echo $row['mi_date_to']; ?>" name="" id="">
                                       </div>
                                       <div class="input_div">
                                          <label for="">Mission Transportation:</label>
                                          <input type="text" class="input_header" value="<?php echo $row['mi_transportation']; ?>" name="" id="">
                                       </div>
                                       <div class="input_div">
                                          <label for="">Mission Direction:</label>
                                          <input type="text" class="input_header" value="<?php echo $row['mi_mission_direction']; ?>" name="" id="">
                                       </div>
                                       <div class="input_div">
                                          <label for="">Company Vehicle Plate Nº:</label>
                                          <input type="text" class="input_header" value="<?php echo $row['mi_company_vihicle_no']; ?>" name="" id="">
                                       </div>
                                       <div class="input_div">
                                          <label for="">Objective:</label>
                                          <input type="text" class="input_header" value="<?php echo $row['mi_objective']; ?>" name="" id="">
                                       </div>
                                    </div>
                                    ...
                                    <div style="margin-top: 10px;">
                                       ...
                                       <a id="medaiprint" style="color: white;" class="btn btn-lg btn-danger" href="./staff_mission.php"><i class="fa fa-undo"></i></a>
                                    </div>
                                 </form>
                              </div>
                           </div>

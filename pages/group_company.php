...
if (isset($_POST["btnadd"])) {
   ...
   $sql = "INSERT INTO company_group 
                        ( cg_name , cg_note ) 
                  VALUES 
                    ('$v_name' , '$v_note' )";
   $result = mysqli_query($connect, $sql);
   header('location:group_company.php?message=success');
}
...
if (isset($_POST["btnupdate"])) {
   ...
   $sql = "UPDATE company_group SET cg_name = '$v_name' , cg_note = '$v_note' WHERE cg_id = $id";

   $result = mysqli_query($connect, $sql);
   header('location:group_company.php?message=update');
}

if (isset($_GET["del_id"])) {
   $id = $_GET["del_id"];

   $sql = "DELETE FROM company_group WHERE cg_id = '$id'";
   $result = mysqli_query($connect, $sql);
   header("location: group_company.php?message=delete");
}
...
<body class="skin-black">
                                 ...
                                 ?>
                                    <tr>
                                       ...
                                       <td style="text-align:center;">
                                          <!-- <a href="edit_position.php?id=<?php echo $row['cg_id']; ?>" class="btn btn-info btn-sm"><i style="color:white;" class="fa fa-eye"></i></a> -->
                                          <a onclick="doUpdate(<?php echo $row['cg_id']; ?>,
                                                        '<?php echo $v_name; ?>',
                                          ...
                                          <a onclick="return confirm('Are you sure to delete ?');" href="group_company.php?del_id=<?php echo $row['cg_id']; ?>" class="btn btn-danger btn-sm"><i style="color:white;" class="fa fa-trash "></i></a>
                                       </td>
                                    </tr>
                                 <?php
                                 }
   ...
   <script type="text/javascript">
      ...
      $(function() {
         ...
         $("#g_company").addClass("active");
         $("#g_company").css("background-color", "##367fa9");

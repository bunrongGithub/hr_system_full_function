                                                            ...
                                                            <div class="form-group col-xs-12">
                                                                ...
                                                                <select class="form-control" id="txt_code" name="txt_code" data-live-search="true" required="required">
                                                                    ...
                                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                                        echo '<option value="' . $row['er_job_id'] . '">' . $row['er_name_kh'] . '</option>';
                                                                    }
                                                                    ?>
                                                                </select>
                                                            </div>
                                    ...
                                    <table id="info_data" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT * FROM admin_stationary_transfer    
                                                                LEFT JOIN text_asset_in_type ON text_asset_in_type.ait_id = admin_stationary_transfer.adstt_type 

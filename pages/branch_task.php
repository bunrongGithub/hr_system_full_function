...
<body class='skin-black'>
   ...
   <div class="wrapper row-offcanvas row-offcanvas-left">
      ...
      <aside class="right-side">
         <section class="content-header">
            <h1 class="text-primary">Branch Task</h1>
            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal"> <i class="fa fa-plus-square-o" aria-hidden="true"></i> Add New</button>
         </section>
         <section>
            <div class="row">
               ...
               <div class="col-xs-12 connectedSortable">
                  <div class="box">
                     <div class="box-body table-responsive">
                        <table id="table_branch_task" class="table table-bordered table-striped">
                           <thead>
                              <tr>
                                 <th>No.</th>
                                 <th>Task_No</th>
                                 ...
                                 <th>Company</th>
                                 <th>Note</th>
                                 <th style="width:110px; text-align:center;"><i class="fa fa-cog"></i></th>
                              </tr>
                           </thead>
                           <tbody>
                              <?php
                              ...
                              while ($row = $result->fetch_assoc()) {
                                 ...
                                 $v_per_inchar_user_id = $row['username'];
                                 $v_assign_user_id = $row['ct_assign_user_id'];
                                 $v_note = $row['ct_note'];
                                 $v_create_at = $row['created_at'];
                              ...
                              ?>
                                 ...
                                 <tr>
                                    ...
                                    <td><?php echo $v_per_inchar_user_id; ?></td>
                                    <td>
                                       <?php
                                       $v_assign_user_id = @$row["ct_assign_user_id"];
                                       $sql_user = "SELECT * FROM user
                                                                     WHERE id=$v_assign_user_id
                                                                     ";
                                    ...
                                    <td>
                                       <i>Company:</i> <?php echo $v_company_id; ?><br>
                                    ...
                                    <td>
                                       <!-- <a 
                                          onclick="doUpdate(<?php echo $row['ct_id']; ?>)" 
                                          class="btn btn-info btn-sm" data-toggle="modal" 
                                          data-target="#modalUpdate<?= $row['ct_id']; ?>">
                                          <i class="fa fa-eye"></i>
                                       </a>
                                    ...
                                    <div class="modal-dialog" role="document">
                                       <div class="modal-content">
                                          <div class="modal-header">
                                             ...
                                             <h3 class="modal-title" id="exampleModalLabel"><i class="fa fa-edit"></i> Update Answer</h3>
                                          </div>
                                          <div class="modal-body">
                                             <div class="row">
                                                <div class="col-md-12">
                                                   <form method="post" action="" enctype="multipart/form-data">
                                                      <input type="hidden" name="id_answer" value="<?php echo $row['ct_id']; ?>" id="">
                                                      ...
                                                      <div class="form-group col-xs-12">
                                                         <button type="submit" name="update_anwer" class="btn btn-primary btn-sm"><i class="fa fa-edit fa-fw"></i>Update</button>
                                                      <a data-dismiss="modal" class="btn btn-danger btn-sm"><i class="fa fa-undo" aria-hidden="true"></i> Back</a>                                                     </div>
                                                   </form>
                                                </div>
                                             </div>
                                          </div>
   ...
   <script type="text/javascript">
      ...
      $(function() {
         ...
         $("#branch_task").addClass("active");
         $("#branch_task").css("background-color", "##367fa9");
         $('#table_branch_task').dataTable();
      });
   </script>
</body>

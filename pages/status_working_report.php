                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="col-md-12">
                                                    <form method="post" enctype="multipart/form-data" action="">
                                                        <input type="hidden" id="edit_twrs_id" name="edit_twrs_id" />
                                                        <div class="form-group col-xs-6">
                                                            <label>Name:</label>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align:center;">
                                                        <!-- <a href="edit_pension.php?id=<?php echo $row['twrs_id']; ?>" class="btn btn-info btn-sm"><i style="color:white;" class="fa fa-eye"></i></a> -->
                                                        <a onclick="doUpdate(<?php echo $row['twrs_id']; ?>,
                                                        ...
                                                        <a onclick="return confirm('Are you sure to delete ?');" href="status_working_report.php?del_id=<?php echo $row['twrs_id']; ?>" class="btn btn-danger btn-sm"><i style="color:white;" class="fa fa-trash "></i></a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }

...
if (isset($_GET['id'])) {
   ...
   $sql = "SELECT * FROM request_new_position 
                        ...
                        LEFT JOIN position on position.position_id = request_new_position.rn_new_position
                        WHERE rn_id = $id";
                           ...
                           <div class="container">
                              <div class="col-md-12">
                                 <form action="" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="" value="<?php echo $row['rn_id'] ?>" id="">
                                    <div class="header_logo">
                                       ...
                                       <div class="header_text">
                                          <h1>Staff Request New Position</h1>
                                       </div>
                                    </div>
                                    <div class="header_input">
                                       ...
                                       <div class="input_div">
                                          ...
                                          <input type="text" class="input_header" name="rnp_no" id="rnp_no" value="<?php echo $row['rn_rnp_no'] ?>">
                                       </div>
                                       <div class="input_div">
                                          <label for="date">Apply Date:</label>
                                          <input type="date" class="input_header" name="date" id="date" value="<?php echo $row['rn_appled_date'] ?>">
                                       </div>
                                    </div>
                                    <div class="header_input">
                                       <div class="input_div">
                                    ...
                                    <div class="current_info">
                                       ...
                                       <div class="input_div_info">
                                          ...
                                          <div class="input_div_info">
                                             ...
                                             <input class="input_header" type="text" name="position" id="position" value="<?php echo $row['position']; ?>">
                                          </div>
                                    </div>
                                    <div class="infor_reason">
                                       <label class="form-label" for="">Reason:</label>
                                       <textarea name="" id="" rows="2"><?php echo $row['rn_reason'] ?></textarea>
                                    </div>
                                    <div class="infor_reason">
                                       <label class="form-label" for="">Noted:</label>
                                       <textarea name="" id="" rows="2"><?php echo $row['rn_note'] ?></textarea>
                                    </div>
                                    ...
                                    <div style="margin-top: 10px;">
                                       ...
                                       <a id="medaiprint" style="color: white;" class="btn btn-lg btn-danger" href="./staff_request_new_position.php"><i class="fa fa-undo"></i></a>
                                    </div>
                                 </form>
                              </div>
                           </div>

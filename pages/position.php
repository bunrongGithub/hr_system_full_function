...
if (isset($_POST["btnupdate"])) {
    ...
    $sql = "UPDATE position SET position = '$v_name' , note = '$v_note' WHERE position_id = $id";
...
<body class="skin-black">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align:center;">
                                                        <!-- <a href="edit_position.php?id=<?php echo $row['position_id']; ?>" class="btn btn-info btn-sm"><i style="color:white;" class="fa fa-eye"></i></a> -->
                                                        <a onclick="doUpdate(<?php echo $row['position_id']; ?>,
                                                        '<?php echo $v_name; ?>',
                                                        ...
                                                        <a onclick="return confirm('Are you sure to delete ?');" href="position.php?del_id=<?php echo $row['position_id']; ?>" class="btn btn-danger btn-sm"><i style="color:white;" class="fa fa-trash "></i></a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            $("#position").css("background-color", "##367fa9");

...
<body class="skin-black">
                                                ...
                                                <div class="col-md-12">
                                                    <form method="post" enctype="multipart/form-data" action="">
                                                        ...
                                                        <div class="form-group col-xs-6" style="margin-top: 40px;">
                                                            <label>Status:</label>
                                                            <input class="form-control" id="txt_cpc_status" name="txt_cpc_status" type="radio" name="contact" id="contact_active" value="Active" />
                                                            <label for="contact_active">Active</label>
                                                            <input class="form-control" id="txt_cpc_status" name="txt_cpc_status" type="radio" name="contact" id="contact_inactive" value="Inactive" />
                                    ...
                                    <table id="info_data" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Total Amount Transfer In Branch</th>
                                                <th>Total Amount Transfer To Branch</th>
                                                <th>End Balance</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            $sql = "SELECT * FROM create_petty_cash A 
                                                    LEFT JOIN pettycash_request B ON B.pc_cpc_id = A.cpc_id
                                                    LEFT JOIN pettycash_exp C ON C.pe_cpc_id = A.cpc_id
                                                    LEFT JOIN petty_cash_transfer_in_branch D ON D.pctb_cpc_id = A.cpc_id
                                                    LEFT JOIN petty_cash_transfer_to_branch E ON E.pcttb_cpc_id = A.cpc_id
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                // $v_cpc_end_balance = $row["cpc_end_balance"];
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $v_pc_amount_usd; ?></td>
                                                    <td><?php echo $v_pe_total_amount; ?></td>
                                                    <td><?php echo $v_pctb_amount; ?></td>
                                                    <td><?php echo $v_pcttb_amount; ?></td>
                                                    <td>
                                                        <?php
                                                            echo $v_cpc_end_balance = $v_pe_total_amount + $v_pctb_amount + $v_pcttb_amount;
                                                        ?>
                                                    </td>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            $("#pc_report").addClass("active");
            $("#pc_report").css("background-color", "##367fa9");

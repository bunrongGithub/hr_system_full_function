...
if (isset($_GET['del_id'])) {
    $v_company_id = $_GET['sent_id'];
    $id = $_GET['del_id'];
    $sql = "DELETE FROM user_auth_company where uac_id = '$id'";
    $result = mysqli_query($connect, $sql);
    header("location: company_auth_user.php?sent_id=$v_company_id");
}
...
if (isset($_POST["btnadd"])) {  
    ...
    $sql = "INSERT INTO user_auth_company
                        (uac_user_id
                        , uac_company_id
                        , created_at)
                    VALUES
...
if (isset($_POST["btnupdate"])) {
    ...
    $sql = "UPDATE user_auth_company SET
                        uac_user_id = '$edit_name'
                        WHERE uac_id = $id";
    $result = mysqli_query($connect, $sql);
    header("location: company_auth_user.php?sent_id=$v_company_id");
    exit();
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <h1 class="text-primary">Company User Auth<h1>
                        
                    <a href="company.php" class="btn btn-danger btn-sm">
                        ...
                        <div style="margin-top: -2%;" class="box">
                            ...
                            <table id="info_data" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                    $id = $_GET['sent_id'];
                                    $sql = "SELECT * FROM user_auth_company A
                                            LEFT JOIN company B ON B.c_id=A.uac_company_id
                                            LEFT JOIN user C ON C.id=A.uac_user_id
                                            WHERE uac_company_id=$id
                                            ";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center" style="vertical-align: middle;" ><?php echo $v_company_id; ?></td>
                                            ...
                                            <td class="text-center" style="vertical-align: middle;" >
                                                ...
                                                <a onclick="doUpdate(
                                                                    '<?php echo $row['uac_id']; ?>',
                                                                    '<?php echo $row['uac_user_id']; ?>'
                                                                    )" data-toggle="modal" data-target="#modalupdate" class="btn btn-primary btn-sm">
                                                    <i style="color: white;" class="fa fa-edit"></i>
                                                </a>
                                                <!-- delete -->
                                                <a onclick="return confirm('Are you sure to delete ?');" href="company_auth_user.php?del_id=<?php echo $row['uac_id']; ?>&sent_id=<?php echo $row['uac_company_id']; ?>" class="btn btn-danger btn-sm">

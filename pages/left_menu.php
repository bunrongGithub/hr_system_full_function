      ...
      <ul class="sidebar-menu">
         ...
         <li id="menu_admin_manage" class="treeview">
            ...
            <ul class="treeview-menu">
               ...
               <li id="asset_balance"><a href="pages/charts/flot.html"><i class="fa fa-print"></i> Asset Balance</a></li>
            </ul>
         </li>
         <li id="menu_stationary_manage" class="treeview">
            ...
            <ul class="treeview-menu">
               ...
               <li id="station_balance"><a href="pages/charts/flot.html"><i class="fa fa-print"></i> Stationary Balance</a></li>
            </ul>
         </li>
         ...
         <li id="menu_staff_update" class="treeview">
            ...
            <ul class="treeview-menu">
               <li id="staff_update"><a href="staff_status_update.php"><i class="fa fa-user-plus"></i> Staff Status Update</a></li>
               ...
               <li id="registration"><a href="staff_registration.php"><i class="fa fa-arrow-right"></i> Registration</a></li>
         ...
         <li id="menu_pc_manage" class="treeview">
            ...
            <ul class="treeview-menu">
               <li id="pc_request"><a href="pettycash_request.php"><i class="fa fa-check"></i> Petty Cash Request</a></li>
               <li id="pc_mgt"><a href="pettycash_mgt.php"><i class="fa fa-check"></i> Petty Cash Mgt</a></li>
            </ul>
         </li>
         <li id="menu_salary" class="treeview">
            ...
            <ul class="treeview-menu">
               ...
               <li id="salary_pay"><a href="pages/examples/invoice.html"><i class="fa fa-arrow-right"></i> Salary Pay Slip</a></li>
            </ul>
         </li>
         <li id="menu_loan" class="treeview">
            ...
            <ul class="treeview-menu">
               ...
               <li id="loan_payment_schedule"><a href="#"><i class="fa fa-arrow-right"></i> Loan Payment Schedule</a></li>
               <li id="loan_balance"><a href="#"><i class="fa fa-arrow-right"></i> Employee Loan Balance
                  </a></li>
            </ul>
         </li>
         <li id="menu_report" class="treeview">
            ...
            <ul class="treeview-menu">
               <li id="emp_pro"><a href="pages/examples/invoice.html"><i class="fa fa-arrow-right"></i> Employee Profile</a></li>
               <li id="re_atten"><a href="pages/examples/invoice.html"><i class="fa fa-arrow-right"></i> Report Attendance</a></li>
               <li id="re_salary"><a href="pages/examples/invoice.html"><i class="fa fa-arrow-right"></i> Report Salary</a></li>
            </ul>
         </li>

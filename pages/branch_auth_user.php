...
if (isset($_GET['del_id'])) {
    $v_branch_id = $_GET['sent_id'];
    $id = $_GET['del_id'];
    $sql = "DELETE FROM user_auth_branch where uab_id = '$id'";
    $result = mysqli_query($connect, $sql);
    header("location: branch_auth_user.php?sent_id=$v_branch_id");
}
...
if (isset($_POST["btnupdate"])) {
    ...
    $sql = "UPDATE user_auth_branch SET
                        uab_user_id = '$edit_name'
                        WHERE uab_id = $id";
    $result = mysqli_query($connect, $sql);
    header("location: branch_auth_user.php?sent_id=$v_branch_id");
    exit();
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <h1 class="text-primary">Branch User Auth<h1>
                        
                    <a href="branch.php" class="btn btn-danger btn-sm">
                            ...
                            <table id="info_data" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * FROM user_auth_branch A
                                            ...
                                            LEFT JOIN user C ON C.id=A.uab_user_id
                                            WHERE uab_branch_id=$id
                                            ";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center" style="vertical-align: middle;" >
                                                ...
                                                <a onclick="doUpdate(
                                                                    '<?php echo $row['uab_id']; ?>',
                                                                    '<?php echo $row['uab_user_id']; ?>'
                                                                    )" data-toggle="modal" data-target="#modalupdate" class="btn btn-primary btn-sm">
                                                    <i style="color: white;" class="fa fa-edit"></i>
                                                </a>
                                                <!-- delete -->
                                                <a onclick="return confirm('Are you sure to delete ?');" href="branch_auth_user.php?del_id=<?php echo $row['uab_id']; ?>&sent_id=<?php echo $row['uab_branch_id']; ?>" class="btn btn-danger btn-sm">

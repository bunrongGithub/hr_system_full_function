                           ...
                           <div class="container">
                              <div class="col-md-12">
                                 <form action="" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="" value="<?php echo $row['re_id'] ?>" id="">
                                    ...
                                    <div class="header_input">
                                       ...
                                       <div class="input_div">
                                          <label for="rnp_no">Resign No:</label>
                                          <input type="text" class="input_header" name="rnp_no" id="rnp_no" value="<?php echo $row['re_no'] ?>">
                                       </div>
                                       <div class="input_div">
                                          <label for="date">Applied Date:</label>
                                          <input type="date" class="input_header" name="date" id="date" value="<?php echo $row['re_resign_date'] ?>">
                                       </div>
                                    </div>
                                    <div class="header_input">
                                       <div class="input_div">
                                    ...
                                    <div class="infor_reason">
                                       ...
                                       <textarea name="" id="" rows="2"><?php echo $row['re_reason'] ?></textarea>
                                    </div>
                                    ...
                                    <div style="margin-top: 10px;">
                                       ...
                                       <a id="medaiprint" style="color: white;" class="btn btn-lg btn-danger" href="./staff_resign.php"><i class="fa fa-undo"></i></a>
                                    </div>
                              </div>
                              </form>
                           </div>

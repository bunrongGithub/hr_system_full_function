...
if (isset($_POST["btnadd"])) {
    ...
    header("location:user_company_sub.php?id=$v_get_id");
}
...
if (isset($_GET["del_id"])) {
    ...
    $sql = "DELETE FROM user_auth_company WHERE uac_id = '$del_id'";
    $result = mysqli_query($connect, $sql);
    header("location:user_company_sub.php?id=$v_get_id");
}
                                                    ...
                                                    <div class="form-group col-xs-6">
                                                        ...
                                                        <select class="form-control" id="txt_company" name="txt_company">
                                                            ...
                                                            while ($row = mysqli_fetch_assoc($result)) {
                                                                echo '<option value="' . $row['c_id'] . '">' . $row['c_name_en'] . '</option>';
                                                            }
                                                            ?>
                                                        </select>
                                                    </div>
                                    ...
                                    <table id="info_data" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT * FROM user_auth_company A
                                                        LEFT JOIN user B ON B.id=A.uac_user_id
                                                        LEFT JOIN company C ON C.c_id=A.uac_company_id
                                                        WHERE uac_user_id=$set_id
                                                        ";
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align:center;">
                                                        ...
                                                        '<?php echo $v_name; ?>')" data-toggle="modal" data-target="#myModal_update" class="btn btn-primary btn-sm"><i style="color:white;" class="fa fa-edit"></i></a>
                                                         -->
                                                        <a onclick="return confirm('Are you sure to delete ?');" href="user_company_sub.php?del_id=<?php echo $row['uac_id']; ?>&sent_user_id=<?php echo $row['uac_user_id']; ?>" class="btn btn-danger btn-sm"><i style="color:white;" class="fa fa-trash "></i></a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }

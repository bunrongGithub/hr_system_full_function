...
<body class="skin-black">
                           ...
                           <table id="info_data" class="table table-hover table-bordered table-striped">
                              <thead>
                                 <tr>
                                    ...
                                    <th style="vertical-align: middle; text-align: center; ">Month Year</th>
                              ...
                              <tbody>
                                 ...
                                 $sql = "SELECT * FROM employee_registration 
                                          ...
                                          LEFT JOIN text_payroll_month_year ON text_payroll_month_year.my_id = employee_registration.er_month_year_id
                                          ";
                                 ...
                                 while ($row = $result->fetch_assoc()) {
                                    ...
                                    $v_my_id = $row["my_name"];
                                    $v_er_status = $row["er_family_status_id"];
                                 ?>
                                    <tr>
                                       ...
                                       <td class="text-center" style="vertical-align: middle;"><?php echo $v_my_id; ?></td>
                                       ...
                                       <td class="text-center" style="vertical-align: middle;"><?php echo $v_er_status; ?></td>
                                    </tr>
                                 <?php
                                 }
                                 ?>
   ...
   <script type="text/javascript">
      $(function() {
         ...
         $("#salary_pay_slip").addClass("active");
         $("#salary_pay_slip").css("background-color", "##367fa9");

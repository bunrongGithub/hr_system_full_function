...
if (isset($_POST["btnupdate"])) {
    ...
    $sql = "UPDATE text_termination_status SET
                    tts_name = '$edit_name'
                    WHERE tts_id = $id";
    $result = mysqli_query($connect, $sql);
    header('location: status_staff_termination.php?message=update');
}
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <h1 class="text-primary">Status Staff Termination<h1>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center" style="vertical-align: middle;" >
                                                <!--list-->
                                                <a href="status_staff_termination_user.php?sent_id=<?php echo $row['tts_id']; ?>" class="btn btn-info btn-sm">
